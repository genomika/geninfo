...
class Report(models.Model):
    ...
    user = models.ForeignKey(User, editable=False, verbose_name="Usuário",
    ...
    created_at = models.DateTimeField(verbose_name="Criado em", auto_now_add=True, editable=False)
...
class Service(models.Model):
    ...
    status_service = models.CharField(choices=INFO_CHOICES, verbose_name="Status do Serviço",
                                        default='op', max_length=30)
...
class Incident(models.Model):
    number_incident = models.CharField(max_length=300, default=increment_id, editable=False)
    name_incident = models.CharField(verbose_name="Nome do incidente", max_length=30)
    status_incident = models.CharField(choices=STATUS_CHOICES, verbose_name="Status do Incidente",
                                        default="pe", max_length=30)
    incident_occurrence = models.CharField(choices=TYPE_CHOICES, max_length=30, default='co', 
                                            verbose_name="Tipo do incidente")
    incident_impact = models.CharField(choices=IMPACT_CHOICES, max_length=30, default='le', verbose_name="Gravidade do incidente")
    finish_date_incidente = models.DateTimeField(verbose_name="Data de Conclusão",
                                                 null=True, blank=True)
    date_incident = models.DateTimeField(verbose_name="Data de inicio", auto_now_add=True)
    last_date_incident = models.DateTimeField(verbose_name="Ultima atualização", auto_now=True)
    description = models.TextField(verbose_name="Descrição do incidente", max_length=400)
    # duration_incident = models.CharField(verbose_name="Duração do incidente", max_length=30)
    services_afted = models.ManyToManyField(Service, verbose_name="Serviços afetados" , related_name='incidents_affected')
