...
def get_home(request):
    ...
    incidents_filter = Incident.objects.filter(date_incident__gte=diff_today).order_by('last_date_incident')
    ...
    return render(request,
            template, {'services': services, 'incidents': incidents, 'incidents_filter': incidents_filter})
...
def get_home_incidents(request):
    ...
    return render(request,
            template, {'services': services, 'incidents': incidents})
